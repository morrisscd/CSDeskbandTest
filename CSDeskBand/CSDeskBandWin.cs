...
namespace CSDeskBand
{
    ...
    public abstract class CSDeskBandWin : ICSDeskBand, IDeskBandProvider
    {
        ...
        //[DllExport("BlankFunction", CallingConvention = CallingConvention.StdCall)]
        //[ComRegisterFunction]
        //public static void BlankFunction(Type t)
        //{
        ...
        [DllExport("Unregister", CallingConvention = CallingConvention.StdCall)]
